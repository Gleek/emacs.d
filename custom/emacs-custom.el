(custom-set-variables
 ...
 '(evil-emacs-state-cursor '("#E57373" bar) t)
 '(evil-insert-state-cursor '("#E57373" hbar) t)
 '(evil-normal-state-cursor '("#00629D" box) t)
 ...
 '(package-selected-packages
   '(vterm transpose-frame auctex all-the-icons-ivy-rich ivy-rich ivy-posframe origami zoom flycheck-posframe smartparens paradox auto-indent-mode vimrc ivy-xref lsp-ivy protobuf-mode php-mode csv-mode rust-mode lua-mode lsp-treemacs smart-jump reformatter string-inflection restart-emacs doom-themes doom-one-theme nord-theme deadgrep flymake-diagnostic-at-point-mode flymake flymake-diagnostic-at-point company-box dap-mode go-playground dumb-jump omnibox easy-kill treemacs treemacs-projectile flyspell-lazy docker docker-compose-mode docker-tramp dockerfile-mode w3m indium geben atom-one-dark-theme elmacro temporary-persistent go-mode tern js2-mode lsp-mode undo-tree yasnippet company all-the-icons form-feed spacemacs-dark phi-search idea-darkula-theme lsp-ui org-noter pdf-tools atomic-chrome edit-server git-gutter exwm yaml-mode projectile-rails rvm robe ibuffer-vc ibuffer-projectile org-jira htmlize howdoi xref-js2 browse-at-remote bind-chord key-chord web-beautify shell-toggle shell-pop lsp-go rg wgrep-ag counsel-projectile all-the-icons-ivy rjsx-mode wgrep company-tern company-restclient flycheck-pos-tip dashboard ansi-term gxref edbi ace-window eshell-git-prompt spaceline-all-the-icons go-guru pandoc-mode org-alert persistent-scratch zeal-at-point projectile-ripgrep vimrc-mode ripgrep counsel-gtags move-text nlinum-relative org-pomodoro zop-to-char zenburn-theme writeroom-mode which-key web-mode vlf use-package sql-indent spacemacs-theme spaceline spacegray-theme solarized-theme smooth-scroll skewer-mode rhtml-mode restclient request-deferred rainbow-mode projectile phpcbf php-boris-minor-mode php+-mode ov org-bullets org nlinum neotree multiple-cursors multi-term multi-eshell markdown-mode magit less-css-mode jump jsx-mode json-rpc json-mode js-doc inf-ruby indent-guide imenu-anywhere hl-line+ helm-gtags helm-ag golden-ratio god-mode git-timemachine ggtags fringe-helper fold-this flycheck fancy-battery expand-region exec-path-from-shell evil esqlite emmet-mode ecb drag-stuff counsel company-web company-quickhelp company-math company-jedi company-go avy apache-mode anzu alert ag))
